      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 transform transition-all duration-500 hover:shadow-purple-500/50 animate-slideUp">
          ...
          <div className="space-y-3 mb-6">
            {/* Google Sign-In Button Container - Google API will render here */}
            <div
              id="googleSignInButton"
              className="w-full flex items-center justify-center min-h-[48px] border-2 border-gray-200 rounded-xl overflow-hidden"
            ></div>
